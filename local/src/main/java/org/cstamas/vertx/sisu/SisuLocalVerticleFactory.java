...
/**
 * A simple {@link VerticleFactory} that uses given class loader to create {@link Verticle} from.
 * Prefix is {@code sisu}. The {@link Verticle} should be annotated with {@link @Named}.
 *
 * @since 1.0
 */
